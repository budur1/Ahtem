...
class _AddNewMedScreen extends State<AddNewMedScreen> {
  ...
  int? intervalDays; //Data is stored in it
  DateTime? selectedDate;
  TextEditingController name = TextEditingController();

  String selectedTimeOfDay = '';
  int dosage = 0; // Added state variable for last  rectangle count
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          onChanged: (value) {
                            setState(() {
                              ...
                              if (preferredTimes ==
                                  'On Specific Days of the week') {
                                isIntervalSelected =
                                    List.generate(1000, (index) => false);
                              } else if (preferredTimes ==
                                  'At Regular Intervals') {
                                DaysOfweek = List.generate(7, (index) => false);
                              }
                            });
                          },
                        ),
                    ...
                    const SizedBox(height: 5.0),
                    if (preferredTimes != 'At Regular Intervals')
                      Column(
                        children: [
                          const Align(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  ...
                                  child: Text(
                                    'Afternoon',
                                    style: TextStyle(
                                      color: selectedTimeOfDay == 'Afternoon'
                                          ? const Color.fromARGB(
                                              255, 123, 56, 162)
                                          : Colors.black,
                                    ),
                    ...
                    if (preferredTimes != 'On Specific Days of the week')
                      const Padding(
                        padding: EdgeInsets.only(left: 16.0),
                        child: Text(
                                    ...
                                    onTap: () {
                                      setState(() {
                                        if (quantityInCabinet > 0) {
                                          quantityInCabinet--; // Adjusted to not go below 1
                                        }
                                      });
                                    },
                                    child: Container(
                        ...
                        child: Row(
                          children: [
                            const Padding(
                              padding: EdgeInsets.only(left: 16.0),
                              child: Text(
                                'How many times do you take it a day?',
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 12,
                                ),
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(15.0),
                                  color: Color.fromARGB(255, 244, 166, 232),
                                ),
                                alignment: Alignment.center,
                                child: Icon(
                                  Icons.arrow_upward,
                            ...
                            GestureDetector(
                              onTap: () {
                                setState(() {
                                  if (dosage > 0) {
                                    dosage--; // Adjusted to not go below 1
                                  }
                                });
                              },
                              child: Container(
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: const Color.fromARGB(255, 228, 82, 131),
                  ...
                  AwesomeDialog(
                    ...
                    btnOkOnPress: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => AddNewMedScreen()),
                      );
                    },
                  ).show();
                }
